...
pub struct EditFunctionClassifications {
    ...
    /// System dialog boxes
    ///> SECURITY: Moderate risk - phishing potential
    ...
    ///> SECURITY: Could disrupt game state if abused
    pub instance: Option<bool>,

    /// Room management functions
    ///> SECURITY: Could break game progression
    ...
    ///> SECURITY: CRITICAL - disable for mods
    // pub os: Option<bool>,
