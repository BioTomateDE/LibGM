...
impl CSharpRng {
    pub fn new(seed: i32) -> Self {
        ...
        let mut num1: i32 = 161803398 - if seed == i32::MIN {i32::MAX} else {seed.abs()};
        num_array[55] = num1;
        let mut num2: i32 = 1;
        ...
        for _ in 1..5 {
            for index4 in 1..56 {
                ...
                num_array[index4] -= num_array[num3 + 1];
                if num_array[index4] < 0 {
                    num_array[index4] += i32::MAX;
                }
            }
        }
    ...
    pub fn next(&mut self) -> i32 {
        ...
        let mut num: i32 = self.seed_array[index1] - self.seed_array[index2];
        if num == i32::MAX {
            num -= 1;
        }
        if num < 0 {
